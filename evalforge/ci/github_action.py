...
class GitHubPRReporter:
    ...
    async def post_comment(self, report: dict[str, Any]) -> bool:
...
class CIPipeline:
    ...
    async def run(self) -> dict[str, Any]:
        ...
        Returns:
            Pipeline result.
        """
        from evalforge.core.runner import EvaluationRunner
        
        # Run evaluation
        runner = EvaluationRunner(backend=self.backend)
        report = await runner.run_suite(self.suite_path)
