        ...
        engine._rules = [
            {
                ...
                "severity": "medium",
                "message": "Mismatch",
                "condition": {"depends_on": "b", "operator": "eq"},
            }
        ]
        ...
        engine._rules = [
            {
                ...
                "severity": "medium",
                "message": "Mismatch",
                "condition": {"depends_on": "b", "operator": "neq"},
            }
        ]
        ...
        engine._rules = [
            {
                ...
                "severity": "medium",
                "message": "Invalid",
                "condition": {"depends_on": "start", "operator": "after"},
            }
        ]
...
class TestBiasCheck:
    ...
    def test_skewed(self, engine: ComplianceEngine) -> None:
        ...
        text = (
            "He did it. He led it. He managed it. He decided. He planned. He executed."
        )
